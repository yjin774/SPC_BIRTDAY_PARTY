...
struct Theme
{
    ...
    {
        return themeDescription + "," + themePrice + "," + themeStatus + "," + themeTemp;
    }
...
struct CustomPackage
{
    ...
    string commaFormat() const
    {
        return item + "," + itemPrice + "," + tempStatus + "," + itemStatus + "," + itemAmountStatus + "," + itemAmount + "," + itemAmtLimit;
    }
...
{   
    ...
    string commaFormat()
    {
        return registers.serialNum + "," + registers.login.nickname + "," + content + "," + rate + "," + fbStatus + "," + viewStatus;
    }
...
void custRegis(string name , int userIndex)
{
    ...
    status = true;
    string confirmation;
    receiptId = generateSerialNo("RE", registerList, [](const Registration<string>& r) {return r.serialNum;});
...
void addReceiptDetails(string receiptType, int index , int customIndex)
{
    ...
    if(!receiptUsernameExist(receiptList , receiptList[index].registers.login.nickname))
    {
        newReceipt.receiptID = receiptId;
        newReceipt.registers.login.nickname = registeredList[index].login.nickname;
...
void viewFeedback(string name,int staffIndex,int feedBackIndex)
{
    ...
    feedbackRecords =
    {
        ...
        {"FEED BACK PROVIDED",feedbackList[feedBackIndex].content}
    };
...
void staffViewFeedBack(string name, int staffIndex)
{
    ...
    while(status)
    {
        ...
        int feedBackIndex = getIndex<Feedback>(feedbackList, ans , [](Feedback f){return f.registers.serialNum;});
...
void staffCreateCampaign(string name, int staffIndex)
{
    ...
    while(status)
    {
        ...
        if(confirmCam == "Y" || confirmCam == "y")
        {
            ...
            newCampaign.contentTitle = c.contentTitle;
            newCampaign.content = c.content;
